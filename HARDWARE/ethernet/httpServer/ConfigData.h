...
typedef struct __S2E_Packet {
	...
	uint8_t module_type[3]; // Assign code to each type of module and use it.
	...
	//struct __network_info network_info[0];	// Using multiple sockets
	struct __serial_info serial_info[2];	// Using multiple serials
